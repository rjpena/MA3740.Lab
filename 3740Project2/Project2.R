#Question 1
require(RCurl)
data<-read.csv(text=getURL("https://raw.githubusercontent.com/rjpena/MA3740.Lab/master/Project2/egg.csv"),header=T)
...
x4<-110
x5<-15
print(y_hat<-(0.012321*x1+.023436*x2+14.630295*x3+0.139536*x4+0.171311*x5-14.006517))
